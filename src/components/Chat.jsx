                ...
                await client.connectUser(
                    {
                        ...
                        name: firebase.currentUser.displayName
                            ...
                            : firebase.currentUser.email.substring(0, 8), // use first 8 characters of email
                        image: firebase.currentUser.photoURL
                            ? firebase.currentUser.photoURL
                            : "https://cdn.dribbble.com/userupload/16679327/file/original-488cabe1e6982d3315c6e878b1b6b85f.png?resize=400x400", // provide your default image URL
                    },
                    token
                );
            } catch (err) {
